     ...
     <div class="container">
          <div class="row my-5">
               <div class="col-md-6 text-center login bg-dark">
                    <h4 class="fw-bold" style="color: white;">Login terlebih dahulu </h4>
                    <?php if (isset($error)) : ?>
                    <?php echo '<script>alert("Username atau Password Salah!,, perhatikan angka dan huruf dengan detai");</script>'; ?>
                    <?php endif; ?>
                    <form action="" method="post">
                         ...
                         <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                              ...
                              <label class="btn btn-outline-primary" for="remember">Remember</label>
