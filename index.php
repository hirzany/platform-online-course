...
<body background="img/bg/bck.jpg">
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Platform online course</a>
     ...
     <div class="container">
          <div class="row my-2">
               <div class="col-md">
                    <h3 class="text-center fw-bold text-uppercase text-light data_peserta"></h3>
                    <hr>
               </div>
          </div>
          <div class="row my-2">
                                ...
                                ?>
                                   ...
                                   <td>
                                        <button class="btn btn-success btn-sm text-white detail"
                                             data-id="<?= $row['id_peserta']; ?>" style="font-weight: 600;"><i
                                                  class="bi bi-info-circle-fill" data-aos="fade-right"
                                                  data-aos-duration="800"></i>Detail</button> |

                                        <a href="ubah.php?id_peserta=<?= $row['id_peserta']; ?>" class="btn btn-warning btn-sm"
                                             style="font-weight: 600;"><i class="bi bi-pencil-square"></i>Ubah</a> |

                                        <a href="hapus.php?id_peserta=<?= $row['id_peserta']; ?>" class="btn btn-danger btn-sm"
     ...
     <div class="modal fade" id="detail" tabindex="-1" aria-labelledby="detail" aria-hidden="true">
          <div class="modal-dialog modal-dialog-scrollable modal-lg">
               <div class="modal-content">
                    ...
                    <div class="modal-body text-center" id="detail-peserta">
                    </div>
               </div>
          </div>
     </div>
     ...
     $(document).ready(function() {
          ...
          $('.detail').click(function() {
               var dataPeserta = $(this).attr("data-id");
               $.ajax({
                    url: "detail.php",
                    method: "post",
                    data: {
